...
struct sop_vi_ctx {
	...
	// dev
	osal_mutex dev_lock[VI_MAX_DEV_NUM];
	...
	// pipe
	osal_mutex pipe_lock[VI_MAX_PIPE_NUM];
	...
	// chn
	vi_chn_attr_s chn_attr[VI_MAX_PIPE_NUM][VI_MAX_CHN_NUM];
	vi_chn_status_s chn_status[VI_MAX_PIPE_NUM][VI_MAX_CHN_NUM];
	vi_crop_info_s chn_crop[VI_MAX_PIPE_NUM][VI_MAX_CHN_NUM];
	rotation_e rotation[VI_MAX_PIPE_NUM][VI_MAX_CHN_NUM];
	vi_ldc_attr_s ldc_attr[VI_MAX_PIPE_NUM][VI_MAX_CHN_NUM];
	vi_early_interrupt_s ealy_int[VI_MAX_PIPE_NUM][VI_MAX_CHN_NUM];
