...
/*           Module Definition            */
/******************************************/
union reg_motion_resize_resize_00 {
	uint32_t raw;
	struct {
		uint32_t resize_enable                   : 1;
		uint32_t dma_enable                      : 1;
		uint32_t _rsv_2                          : 3;
		uint32_t resize_debug_mode               : 4;
	} bits;
};

union reg_motion_resize_resize_04 {
	uint32_t raw;
	struct {
		uint32_t resize_fg_height                : 16;
		uint32_t resize_fg_width                 : 16;
	} bits;
};

union reg_motion_resize_resize_08 {
	uint32_t raw;
	struct {
		uint32_t resize_dst_width                : 16;
		uint32_t resize_dst_height               : 16;
	} bits;
};

union reg_motion_resize_resize_0c {
	uint32_t raw;
	struct {
		uint32_t resize_debug_invld              : 1;
		uint32_t resize_debug_dmavld             : 1;
		uint32_t resize_debug_inrdy              : 1;
		uint32_t resize_debug_dmardy             : 1;
		uint32_t resize_debug_eol                : 1;
	} bits;
};

union reg_motion_resize_resize_10 {
	uint32_t raw;
	struct {
		uint32_t crop_enable                     : 1;
	} bits;
...
union reg_motion_resize_resize_20 {
	uint32_t raw;
	struct {
		uint32_t _rsv_0                          : 24;
		uint32_t shd_rd                          : 1;
