...
#define MAX_INST_HANDLE_SIZE 256 /* DO NOT CHANGE THIS VALUE */
...
#define ONE_TASKBUF_SIZE_FOR_W5DEC_CQ                                          \
	(8 * 1024 * 1024) /* upto 8Kx4K, need 8Mbyte per task*/
#define ONE_TASKBUF_SIZE_FOR_W5ENC_CQ                                          \
	(16 * 1024 *                                                           \
	 1024) /* upto 8Kx8K, need 16Mbyte per task. (worst case VLC data =: 13M for 8kx8k) */
