...
#define REG_SCL_GOP_FONTBOX_CTRL(x) (REG_SCL_GOP_BASE(x) + 0x120)
#define REG_SCL_GOP_FONTBOX_CFG(x, y) (REG_SCL_GOP_BASE(x) + 0x10*y + 0x124)
#define REG_SCL_GOP_FONTBOX_INIT(x, y) (REG_SCL_GOP_BASE(x) + 0x10*y + 0x128)
#define REG_SCL_GOP_FONTBOX_REC(x, y) (REG_SCL_GOP_BASE(x) + 0x10*y + 0x12c)
...
#define REG_SCL_ODMA_INT_LINE_TARGET(x) (REG_SCL_ODMA_BASE(x) + 0x38)
...
#define REG_SCL_DISP_GOP_FONTBOX_CTRL (REG_SCL_DISP_BASE + REG_GOP_OFFSET + 0x120)
#define REG_SCL_DISP_GOP_FONTBOX_CFG(y) (REG_SCL_DISP_BASE + REG_GOP_OFFSET + 0x10*y + 0x124)
#define REG_SCL_DISP_GOP_FONTBOX_INIT(y) (REG_SCL_DISP_BASE + REG_GOP_OFFSET + 0x10*y + 0x128)
#define REG_SCL_DISP_GOP_FONTBOX_REC(y) (REG_SCL_DISP_BASE + REG_GOP_OFFSET + 0x10*y + 0x12c)
