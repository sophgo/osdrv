...
union REG_SUBLVDS_CTRL_TOP_30 {
	uint32_t raw;
	struct {
		uint32_t SLVDS_LANE_MODE                 : 2;
		uint32_t _rsv_2                          : 2;
		uint32_t SLVDS_SYNC_SOURCE               : 4;
		uint32_t _rsv_8                          : 4;
