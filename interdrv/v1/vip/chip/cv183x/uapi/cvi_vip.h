...
#define V4L2_CID_DV_VIP_IMG_SET_VPSS_GRP_CFG    (V4L2_CID_DV_VIP_IMG_BASE + 2)
#define V4L2_CID_DV_VIP_IMG_CLR_VPSS_GRP_CFG    (V4L2_CID_DV_VIP_IMG_BASE + 3)
...
#define V4L2_CID_DV_VIP_IMG_OFFLINE_TRIG        (V4L2_CID_DV_VIP_IMG_BASE + 7)
...
#define V4L2_CID_DV_VIP_SC_SET_ALIGN            (V4L2_CID_DV_VIP_SC_BASE + 1)
#define V4L2_CID_DV_VIP_SC_SET_RGN_LUT          (V4L2_CID_DV_VIP_SC_BASE + 2)
#define V4L2_CID_DV_VIP_SC_SET_VPSS_CHN_CFG     (V4L2_CID_DV_VIP_SC_BASE + 3)
#define V4L2_CID_DV_VIP_SC_SET_BIND_FB          (V4L2_CID_DV_VIP_SC_BASE + 4)
#define V4L2_CID_DV_VIP_SC_RELEASE_BUF          (V4L2_CID_DV_VIP_SC_BASE + 5)
...
enum V4L2_CID_DV_VIP_ISP {
	...
	V4L2_CID_DV_VIP_ISP_ENABLE_DEV,
};
...
#define V4L2_EVENT_CVI_VIP_VPSS_EARLY_INT	(V4L2_EVENT_CVI_VIP_CLASS | 0x22)
 ...
 * @is_online: only meaningful on sc qbuf
 * @reserved
 */
