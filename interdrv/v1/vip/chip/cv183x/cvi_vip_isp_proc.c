 ...
 *
 * File Name: cvi_vip_isp_proc.c
 * Description: isp engine info
 */
...
{
	struct cvi_isp_vdev *vdev = PDE_DATA(inode);

	isp_prc_unit.isp_prc_int_flag = 0;
	_isp_v4l2_event_queue(vdev, V4L2_EVENT_CVI_VIP_ISP_PROC_READ, 0);
