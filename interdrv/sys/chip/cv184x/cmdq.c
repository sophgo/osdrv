...
osal_module_export(cmdq_set_package);
...
osal_module_export(cmdq_set_wait);
...
osal_module_export(cmdq_adma_package);
...
osal_module_export(cmdq_intr_ctrl);
...
osal_module_export(cmdq_intr_clr);
...
osal_module_export(cmdq_intr_status);
		...
		bool is_hw_restart, bool is_adma, u16 cnt)
{
	...
	_reg_write(base + REG_CMDQ_DMA_ADDR_H, 0);
...
osal_module_export(cmdq_engine);
