...
int ldc_rm_cb(void);
int ldc_reg_cb(struct ldc_ctx *wdev);
 ...
 */
int ldc_begin_job(struct ldc_ctx *wdev,
 ...
 * @return Error code (0 if successful)
 */
int ldc_end_job(struct ldc_ctx *wdev, unsigned long long handle);
 ...
 * @return Error code (0 if successful)
 */
int ldc_cancel_job(struct ldc_ctx *wdev, unsigned long long handle);
int ldc_get_work_job(struct ldc_ctx *wdev, struct gdc_handle_data *data);
 ...
 * @return Error code (0 if successful)
 */
int ldc_add_rotation_task(struct ldc_ctx *wdev, struct gdc_task_attr *attr);
int ldc_add_ldc_task(struct ldc_ctx *wdev, struct gdc_task_attr *attr);
int ldc_get_chn_frame(struct ldc_ctx *wdev, struct gdc_identity_attr *identity
...
int ldc_sw_init(struct ldc_ctx *wdev);
void ldc_sw_deinit(struct ldc_ctx *wdev);

int ldc_set_identity(struct ldc_ctx *wdev,
...
static inline int ldc_check_param_is_valid(struct ldc_ctx *wdev, struct gdc_task_attr *attr)
{
	int ret = 0;
