...
#define CIF_MCLK_GEN_BASE 0x03002800
#define CIF_MCLK_GROUP0_PLL 0xC0
#define CIF_MCLK_GROUP1_PLL 0xC4
#define CIF_MCLK_GROUP2_PLL 0xC8

#define MAX_LINK_NUM		3
#define MAX_CAM_CLK_NUM		3
#define MAX_WDR_FRAME_NUM	2
#define MAX_VC_NUM			4
#define CIF_MAX_CSI_NUM		3
#define MAX_PAD_NUM			18
#define MAC0_MAX_CLK 600
