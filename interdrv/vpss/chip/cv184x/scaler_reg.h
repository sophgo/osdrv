...
// #define REG_VPSS_BASE 0x0a080000

#define REG_VPSS_SIZE 0X4000
...
#define REG_SCL_TOP_BASE(x)  (REG_VPSS_SIZE * x + REG_TOP_OFFSET)
#define REG_SCL_CMDQ_BASE(x) (REG_VPSS_SIZE * x + REG_CMDQ_OFFSET)
#define REG_SCL_IMG_BASE(x)  (REG_VPSS_SIZE * x + REG_IMG_OFFSET)
#define REG_SCL_CORE_BASE(x) (REG_VPSS_SIZE * x + REG_CORE_OFFSET)
#define REG_SCL_GOP0_BASE(x) (REG_VPSS_SIZE * x + REG_GOP0_OFFSET)
#define REG_SCL_GOP1_BASE(x) (REG_VPSS_SIZE * x + REG_GOP1_OFFSET)
#define REG_SCL_ODMA_BASE(x) (REG_VPSS_SIZE * x + REG_ODMA_OFFSET)
...
#define REG_SC_TOP_SB_CBAR(x) (REG_SCL_TOP_BASE(x) + 0x1C)
...
#define REG_SCL_ODMA_SB_C_STAT(x) (REG_SCL_ODMA_BASE(x) + 0x54)
#define REG_SCL_ODMA_SB_Y_STAT(x) (REG_SCL_ODMA_BASE(x) + 0x58)
