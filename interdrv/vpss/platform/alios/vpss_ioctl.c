...
long vpss_ioctl(struct vpss_cores *cores, unsigned int cmd, unsigned long arg)
{
	...
	case VPSS_SET_MODE:
	{
		const vpss_mode_s *cfg = (vpss_mode_s *)arg;
	...
	case VPSS_GET_MODE:
	{
		vpss_mode_s *cfg = (vpss_mode_s *)arg;
	...
	{
		const vpss_mod_param_s *cfg = (vpss_mod_param_s *)arg;
	...
	{
		vpss_mod_param_s *cfg = (vpss_mod_param_s *)arg;
	...
	{
		struct vpss_grp_cfg *cfg = (struct vpss_grp_cfg *)arg;
	...
	{
		struct vpss_chn_csc_cfg *cfg = (struct vpss_chn_csc_cfg *)arg;
	...
	{
		struct vpss_chn_cfg *attr = (struct vpss_chn_cfg *)arg;
	...
	{
		struct vpss_chn_rot_cfg *cfg = (struct vpss_chn_rot_cfg *)arg;
		vpss_grp vpss_grp = cfg->vpss_grp;
		vpss_chn vpss_chn = cfg->vpss_chn;
	...
	{
		struct vpss_chn_ldc_cfg *cfg = (struct vpss_chn_ldc_cfg *)arg;
		vpss_grp vpss_grp = cfg->vpss_grp;
		vpss_chn vpss_chn = cfg->vpss_chn;
	...
	{
		struct vpss_chn_draw_rect_cfg *cfg = (struct vpss_chn_draw_rect_cfg *)arg;
		vpss_grp vpss_grp = cfg->vpss_grp;
		vpss_chn vpss_chn = cfg->vpss_chn;
	...
	{
		struct vpss_chn_convert_cfg *cfg = (struct vpss_chn_convert_cfg *)arg;
		vpss_grp vpss_grp = cfg->vpss_grp;
		vpss_chn vpss_chn = cfg->vpss_chn;
	...
	{
		struct vpss_coverex_cfg *cfg = (struct vpss_coverex_cfg *)arg;
		vpss_grp vpss_grp = cfg->vpss_grp;
		vpss_chn vpss_chn = cfg->vpss_chn;
	...
	{
		struct vpss_mosaic_cfg *cfg = (struct vpss_mosaic_cfg *)arg;
		vpss_grp vpss_grp = cfg->vpss_grp;
		vpss_chn vpss_chn = cfg->vpss_chn;
	...
	{
		struct vpss_gop_cfg *cfg = (struct vpss_gop_cfg *)arg;
		vpss_grp vpss_grp = cfg->vpss_grp;
		vpss_chn vpss_chn = cfg->vpss_chn;
		u32 layer = cfg->layer;
	...
	{
		struct vpss_proc_amp_ctrl_cfg *cfg = (struct vpss_proc_amp_ctrl_cfg *)arg;
	...
	{
		struct vpss_proc_amp_cfg *cfg = (struct vpss_proc_amp_cfg *)arg;
		vpss_grp vpss_grp = cfg->vpss_grp;
	...
	{
		vpss_all_proc_amp_s *cfg = (vpss_all_proc_amp_s *)arg;
