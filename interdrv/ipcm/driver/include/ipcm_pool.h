...
#define IPCM_RTOS_ADDR  CVIMMAP_ALIOS_RESV_ADDR
#define IPCM_RTOS_SIZE  CVIMMAP_ALIOS_RESV_SIZE
#define IPCM_LOG_ADDR  CVIMMAP_ALIOS_LOG_ADDR
#define IPCM_LOG_SIZE  CVIMMAP_ALIOS_LOG_SIZE
