...
CVI_S32 CVI_VDEC_SetProtocolParam(VDEC_CHN VdChn,
...
CVI_S32 CVI_VDEC_GetUserData(VDEC_CHN VdChn, VDEC_USERDATA_S *pstUserData,
                 CVI_S32 s32MilliSec);
CVI_S32 CVI_VDEC_ReleaseUserData(VDEC_CHN VdChn,
                 const VDEC_USERDATA_S *pstUserData);

CVI_S32 CVI_VDEC_SetUserPic(VDEC_CHN VdChn,
...
CVI_S32 CVI_VDEC_SetDisplayMode(VDEC_CHN VdChn,
                VIDEO_DISPLAY_MODE_E enDisplayMode);
CVI_S32 CVI_VDEC_GetDisplayMode(VDEC_CHN VdChn,
...
CVI_S32 CVI_VDEC_SetUserDataAttr(VDEC_CHN VdChn,
                 const VDEC_USER_DATA_ATTR_S *pstUserDataAttr);
CVI_S32 CVI_VDEC_GetUserDataAttr(VDEC_CHN VdChn,
