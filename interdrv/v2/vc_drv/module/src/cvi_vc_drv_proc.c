...
// TODO: following info should be amended later
                ...
                seq_printf(
                    ...
                    idx, pstFPS->u32InFPS,
                    pstFPS->u32OutFPS, pstFPS->u64HwTime, pstFPS->u64MaxHwTime);
    ...
    for (idx = 0; idx < MaxVencChnNum; idx++) {
        if (handle->chn_handle[idx] != NULL &&
            ...
            seq_printf(
                ...
                pstChnAttr->stVencAttr.u32BufSize ? pstChnAttr->stVencAttr.u32BufSize : CVI_H26X_DEFAULT_BUFSIZE,
    ...
    for (idx = 0; idx < MaxVencChnNum; idx++) {
        if (handle->chn_handle[idx] != NULL &&
            ...
            seq_printf(
                ...
                pstChnAttr->stVencAttr.u32PicWidth,
                pstChnAttr->stVencAttr.u32PicHeight,
                pstChnAttr->stVencAttr.u32BufSize ? pstChnAttr->stVencAttr.u32BufSize : CVI_JPG_DEFAULT_BUFSIZE,
