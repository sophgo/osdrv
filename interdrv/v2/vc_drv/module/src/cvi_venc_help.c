...
int setMapData(int core_idx, cviRoiParam *roi_rect, int roi_base_qp, int picWidth, int picHeight, WaveCustomMapOpt *customMapOpt,
    ...
    if (VPU_GetProductId(0) == PRODUCT_ID_521 && bitstreamFormat == STD_AVC) {
        ...
        GenQpMapFromRoiRegion(roi_rect, picWidth, picHeight, roi_base_qp, roiMapBuf , STD_AVC); //initial qp should be set ？
        ...
        GenQpMapFromRoiRegion(roi_rect, picWidth, picHeight, roi_base_qp, roiMapBuf, STD_HEVC); //initial qp should be set ？
