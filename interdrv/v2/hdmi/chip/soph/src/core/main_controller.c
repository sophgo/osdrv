...
static void __maybe_unused mc_cec_clock_enable(hdmi_tx_dev_t *dev, u8 bit)
{
...
static void __maybe_unused mc_pixel_repetition_clock_reset(hdmi_tx_dev_t *dev, u8 bit)
{
...
static void __maybe_unused mc_pixel_clock_reset(hdmi_tx_dev_t *dev, u8 bit)
{
...
static u8 __maybe_unused mc_lock_on_clock_status(hdmi_tx_dev_t *dev, u8 clockDomain)
{
	return (u8)((dev_read(MC_LOCKONCLOCK) >> clockDomain) & 0x1);
}

static void __maybe_unused mc_lock_on_clock_clear(hdmi_tx_dev_t *dev, u8 clockDomain)
{
