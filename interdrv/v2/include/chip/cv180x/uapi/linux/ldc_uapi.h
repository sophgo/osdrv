...
#define CVI_LDC_BEGIN_JOB _IOWR('D', 0x00, struct gdc_handle_data)
#define CVI_LDC_END_JOB _IOW('D', 0x01, struct gdc_handle_data)
#define CVI_LDC_CANCEL_JOB _IOW('D', 0x02, unsigned long long)
#define CVI_LDC_ADD_ROT_TASK _IOW('D', 0x03, struct gdc_task_attr)
#define CVI_LDC_ADD_LDC_TASK _IOW('D', 0x04, struct gdc_task_attr)

#define CVI_LDC_SET_BUF_WRAP _IOW('D', 0x10, struct ldc_buf_wrap_cfg)
#define CVI_LDC_GET_BUF_WRAP _IOWR('D', 0x11, struct ldc_buf_wrap_cfg)
