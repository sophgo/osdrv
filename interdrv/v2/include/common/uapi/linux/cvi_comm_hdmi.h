...
typedef enum _CVI_HDMI_ERRORCODE {
    CVI_ERR_HDMI_SCDC_FAILED    = -100,
    CVI_ERR_HDMI_DEV_POINTER_INVALID,
    CVI_ERR_HDMI_ARG_INVALID,
    CVI_ERR_HDMI_VIDEO_CONFIG_FAILED,
    CVI_ERR_HDMI_VIDEO_ARGS_INVALID,
    CVI_ERR_HDMI_COLOR_DEPTH_INVALID,
    CVI_ERR_HDMI_COLOR_REMAP_SIZE_INVALID,
    CVI_ERR_HDMI_OUTPUT_ENCODETYPE_INVALID,
    CVI_ERR_HDMI_INTERPOLATION_FILTER_INVALID,
    CVI_ERR_HDMI_DECIMATION_FILTER_INVALID,
    CVI_ERR_HDMI_INVALID_INPUT_ENCODETYPE,
    CVI_ERR_HDMI_AUDIO_ARGS_INVALID,
    CVI_ERR_HDMI_3DSTRUCTURE_NOT_SUPPORT,
    CVI_ERR_HDMI_SCRAMBLING_FAILED,
    CVI_ERR_HDMI_PHY_NOT_CONFIG,
    CVI_ERR_HDMI_PHY_PLL_NOT_LOCK,
    CVI_ERR_HDMI_HDCP_NOT_SUPORRT,
