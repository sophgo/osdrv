...
int ispblk_dma_buf_get_size2(struct isp_ctx *ctx, int dmaid, u8 raw_num)
{
	...
	case ISP_BLK_ID_DMA_CTL19: //fe2_csibdg_se
	{
		...
		if (dmaid == ISP_BLK_ID_DMA_CTL12 || dmaid == ISP_BLK_ID_DMA_CTL13)
			raw_num = ISP_PRERAW1;
		else if (dmaid == ISP_BLK_ID_DMA_CTL18 || dmaid == ISP_BLK_ID_DMA_CTL19)
			raw_num = ISP_PRERAW2;
		//ToDo
		//else
...
int ispblk_dma_config(struct isp_ctx *ctx, int dmaid, uint64_t buf_addr)
{
	...
	case ISP_BLK_ID_DMA_CTL19: //fe2_csibdg_se
		/* csibdg */
		if (dmaid == ISP_BLK_ID_DMA_CTL8 || dmaid == ISP_BLK_ID_DMA_CTL9)
			raw_num = ISP_PRERAW1;
		else if (dmaid == ISP_BLK_ID_DMA_CTL18 || dmaid == ISP_BLK_ID_DMA_CTL19)
			raw_num = ISP_PRERAW2;
		//ToDo
					...
					const enum cvi_isp_raw raw_num)
{
	...
	switch (dmaid) {
	case ISP_BLK_ID_DMA_CTL6: //pre_raw_fe0
	case ISP_BLK_ID_DMA_CTL7:
	case ISP_BLK_ID_DMA_CTL8: //pre_raw_fe1
	case ISP_BLK_ID_DMA_CTL9:
	case ISP_BLK_ID_DMA_CTL12: //pre_raw_fe1
	case ISP_BLK_ID_DMA_CTL13:
	case ISP_BLK_ID_DMA_CTL18: //pre_raw_fe2
	case ISP_BLK_ID_DMA_CTL19:
		/* csibdg */
