...
#define MAX_INST_HANDLE_SIZE 880
...
#define VPU_REORDER_DISABLE 0
	  // it can be set to 0 to disable reordering DPB in host side.
...
#define ONE_TASKBUF_SIZE_FOR_W5DEC_CQ                                          \
	(8 * 1024 * 1024)
/* upto 8Kx4K, need 8Mbyte per task*/
#define ONE_TASKBUF_SIZE_FOR_W5ENC_CQ                                          \
	(16 * 1024 * 1024)
...
#define SIZE_COMMON_265 (SIZE_COMMON)
#define SIZE_COMMON_264 (SIZE_COMMON)
//=====4. VPU REPORT MEMORY  ======================//
