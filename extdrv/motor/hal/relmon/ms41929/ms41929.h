...
//CAILB PARAM CONFIG
#define FOCUS_RANGE    (22000)//(14000) // 1750
#define ZOOM_RANGE     (20000)//(13656) //1707
#define FOCUS_OFFSET   (0)
#define ZOOM_OFFSET    (9656) // 1207
#define FOCUS_BACKLASH (140) // 25
#define ZOOM_BACKLASH  (280)
...
#define FOCUS_ONE_STEP_TIME_COST  (400) //us 2768
#define ZOOM_ONE_STEP_TIME_COST   (400) //us
