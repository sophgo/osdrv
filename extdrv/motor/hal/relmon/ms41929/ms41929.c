...
{
	// PINMUX_CONFIG(GPIO3, SPI1_SCK, G12);//CLOCK
	// PINMUX_CONFIG(GPIO2, SPI1_SDO, G12);//OUT
	// PINMUX_CONFIG(GPIO1, SPI1_SDI, G12);//IN
	// PINMUX_CONFIG(GPIO0, SPI1_CS_X, G12);//CS
	PINMUX_CONFIG(UART1_RTS, GPIO85, G11);//VD_FZ
	gpio_request(VD_FZ_PIN_NUM, NULL);
}

void ms41929_pinmux_resume(void)
{
	// PINMUX_CONFIG(GPIO3, GPIO114, G12);//CLOCK
	// PINMUX_CONFIG(GPIO2, A53_JTAG0_TDI, G12);//OUT
	// PINMUX_CONFIG(GPIO1, GPIO112, G12);//IN
	// PINMUX_CONFIG(GPIO0, GPIO111, G12);//CS
	PINMUX_CONFIG(UART1_RTS, GPIO85, G11);//VD_FZ
